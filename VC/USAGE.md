...
This doc shows the minimal end-to-end flow for using `VC` to commit, open, and check. After L1, the example below works for real; at L0, only the typecheck and the size-0 smoke test pass.
...
To use `VC` as a correctness oracle for the Rust crate:
